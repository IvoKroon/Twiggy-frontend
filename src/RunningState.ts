...
module Twiggy{
    ...
    create() {
        ...
        TwiggyGame.energy = new Energy(20, 20, Math.floor(TwiggyGame.userData.energy), Energy.prototype.action, this.game);
        TwiggyGame.energy.setSizes(15, 20);
        TwiggyGame.energy.render();
        ...
        TwiggyGame.coin = new Coin(this.game.width - 200, 20, 200, Coin.prototype.action, this.game);
        TwiggyGame.coin.setSizes(20, 20);
        TwiggyGame.coin.render();
        TwiggyGame.coin.inputEnabled = true;
        TwiggyGame.coin.events.onInputDown.add(this.clearCookie.bind(this), this);
    ...
    loadNewState() {
        ...
        if (!TwiggyGame.growButtonExist) {
            TwiggyGame.growButtonExist = true;
            let growButtonHeight = this.game.cache.getImage('gb').height / 1.5;
            let growButtonWidth = this.game.cache.getImage('gb').width / 1.5;
    ...
    update() {
        ...
        if(this.counter > 30){
            TwiggyGame.userData.energy += 20;

            this.counter = 0;
        }
        //set the new energy
        TwiggyGame.energy.amount = TwiggyGame.userData.energy;
        this.counter ++;
